...
Original file is located at
    https://colab.research.google.com/drive/1vg7D2rSreV0Riy2yJY71YiWqLvhqzUej
"""
...
loader = PyPDFLoader('/content/Business Plan ITHG AI EN for Daia.pdf')
pages = loader.load()
page=pages[1]
...
class cbfs(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.panels = []
        self.loaded_file = "/content/Business Plan ITHG AI EN for Daia.pdf"
